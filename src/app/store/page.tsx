...
import { Store, ShieldCheck, MapPin, ShoppingBag, Search, Plus, ExternalLink, Check } from 'lucide-react';
...
export default function StoreCatalogPage() {
  ...
  useEffect(() => {
    fetch('/api/products')
      ...
      .catch(err => console.warn('[Store] Failed to fetch live products:', err))
      ...
      <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
        ...
        {loading ? (
          ...
          <div style={{ padding: '60px', textAlign: 'center', background: '#fff', borderRadius: '12px', border: '1px dashed #cbd5e1' }}>
            <p style={{ color: '#64748b', fontSize: '1.1rem', margin: '0 0 12px 0' }}>No products found matching your search.</p>
